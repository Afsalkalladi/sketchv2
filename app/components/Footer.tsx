        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-10 mb-[clamp(2rem,3vw,3.5rem)]">
          ...
          <div className="flex flex-col justify-start">
            ...
            >
              ...
              TailwindCSS, providing everything you need to jumpstart your Astro
          ...
          <div className="flex flex-col md:items-start md:ml-auto w-full max-w-xl">
            ...
            <div className="w-full">
              ...
              <div className="flex flex-wrap gap-x-10 gap-y-3">
                {["About Us", "Projects", "Gallery", "Careers"].map((link) => (
                  <a
                    key={link}
                    href="#"
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-3">
                ...
                "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.217.792 24 1.771 24h20.451C23.2 24 24 23.217 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"
                ].map((path, idx) => (
                  <a key={idx} href="#" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-white/10 transition-all">
                    <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24"><path d={path}></path></svg>
                  </a>
                ))}
            </div>
          </div>
